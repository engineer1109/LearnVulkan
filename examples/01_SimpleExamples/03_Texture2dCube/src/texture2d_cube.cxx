...
void Texture2dCube::preparePipelines()
{
    ...
    shaderStages[0] = loadShader(FS::getAssetPath("shaders/03_Texture2dCube/texture.so.vert"), VK_SHADER_STAGE_VERTEX_BIT);
    shaderStages[1] = loadShader(FS::getAssetPath("shaders/03_Texture2dCube/texture.so.frag"), VK_SHADER_STAGE_FRAGMENT_BIT);
